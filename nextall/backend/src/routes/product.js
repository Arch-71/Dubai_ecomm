...
router.post('/products', verifyToken, product.createProductByAdmin);
router.get('/products', verifyToken, product.getProductsByAdmin);
router.get('/products/:slug', verifyToken, product.getOneProductByAdmin);
router.put('/products/:slug', verifyToken, product.updateProductByAdmin);
